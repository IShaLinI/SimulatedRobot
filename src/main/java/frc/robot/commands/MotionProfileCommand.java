...
public class MotionProfileCommand extends CommandBase {
    ...
    /**
     * Creates a new MotionProfileCommand with no extra constraints. Drives along
     * the specified path
     * based on odometry data.
     */
    public MotionProfileCommand(Drive drive,
            double startVelocityMetersPerSec, List<Pose2d> waypoints,
            double endVelocityMetersPerSec, boolean reversed) {
        this(drive, startVelocityMetersPerSec, waypoints,
                endVelocityMetersPerSec, reversed, List.of());
    }

    /**
     * Creates a new MotionProfileCommand with extra constraints. Drives along the
     * specified path
     * based on odometry data.
     */
    public MotionProfileCommand(Drive drive,
